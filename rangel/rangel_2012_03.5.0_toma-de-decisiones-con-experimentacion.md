...
El **análisis a posteriori** es simplemente el proceso de calcular el Valor Esperado Monetal (VEM) usando **probabilidades actualizadas** (a posteriori) que incorporan la información que obtuviste de un experimento o muestra.

La palabra "posteriori" significa "después de la experiencia". Así que las probabilidades a posteriori son las que calculas *después* de ver los resultados de tu experimento.
